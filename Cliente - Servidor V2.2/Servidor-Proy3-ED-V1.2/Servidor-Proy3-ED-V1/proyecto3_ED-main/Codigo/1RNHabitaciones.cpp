...
class NodoHabitacion {
   ...
   string getInfoHabitacion(){
      return to_string(CodHabitacion)+"|"+string(TipoCuarto)+"|"+to_string(NumeroCamas)+"|"+to_string(PrecioHabitacion)+"|"+EstadoHab+"|";
   }
...
class ArbolRN_Habitaciones {
   public:
    ...
    string MostrarNodo(pnodohabitacion aux);
    string Mostrar();
...
string infoHabs;
string ArbolRN_Habitaciones :: Mostrar(){
...
void ArbolRN_Habitaciones :: Mostrar(pnodohabitacion aux){
   ...
   string espacio = "|";
   infoHabs += to_string(aux->CodHabitacion) + espacio + string(aux->TipoCuarto) + espacio + to_string(aux->NumeroCamas) + espacio + to_string(aux->PrecioHabitacion) + espacio + aux->EstadoHab + espacio;
}

string ArbolRN_Habitaciones :: MostrarNodo(pnodohabitacion aux){
   //Permite imprimir la informacion del nodo recibido
   if (aux != NULL){
      string espacio = "|";
      return to_string(aux->CodHabitacion) + espacio + string(aux->TipoCuarto) + espacio + to_string(aux->NumeroCamas) + espacio + to_string(aux->PrecioHabitacion) + espacio + aux->EstadoHab + espacio;
   }
}
