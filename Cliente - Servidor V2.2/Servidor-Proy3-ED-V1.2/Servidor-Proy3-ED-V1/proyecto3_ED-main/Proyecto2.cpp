...
void insertar_Nodo(bool AH, int numero, pnodohotel& ultimoHotel, pnodopisohotel& ultimoPiso, pnodohabitacion& ultimaHabitacion, pnodoAgencia& ultimaAgencia, pnodotipoflotilla& ultimaFlotilla, pnodocarro& ultimoCarro){
        ...
        case 4: // Reservacion de hotel
            ...
            */
            ...
            if (entradaChar2[0] == 'L'){
                ...
                Reservac->InsertarInicio(entradaInt1,entradaInt2,entradaInt3,entradaInt4, habitacion);
                cout<< "\nReservacion exitosa\n";
                break;
            }
        ...
        case 5: // Reservacion de agecia
            ...
            */
            ...
            if (entradaChar2[0] == 'L'){
                ...
                Reservac->InsertarInicio(entradaInt1,entradaInt2,entradaInt3,entradaInt4, carro);
                cout<< "\nReservacion exitosa\n";
                break;
            }
...
int main(){
    ...
    while (control != 0){ //control de todo el sistema
        ...
        case 5: // menu inserciones
            ...
            case 1:
                insertar_Nodo(AH, 1, ultimoHotel, ultimoPiso, ultimaHabitacion, ultimaAgencia, ultimaFlotilla, ultimoCarro); //hoteles/agencias
                break;

            case 2:
                insertar_Nodo(AH, 2, ultimoHotel, ultimoPiso, ultimaHabitacion, ultimaAgencia, ultimaFlotilla, ultimoCarro); //piso/flotilla
                break;

            case 3:
                insertar_Nodo(AH, 3, ultimoHotel, ultimoPiso, ultimaHabitacion, ultimaAgencia, ultimaFlotilla, ultimoCarro); //habitaciones/carros
                break;
        ...
        case 12: // menu mantenimiento
            ...
            case 1:
                insertar_Nodo(true,0, ultimoHotel, ultimoPiso, ultimaHabitacion, ultimaAgencia, ultimaFlotilla, ultimoCarro);
                break;
        ...
        case 13: // menu reservaciones
            ...
            case 1: //reservar hotel
                ...
                insertar_Nodo(true,4, ultimoHotel, ultimoPiso, ultimaHabitacion, ultimaAgencia, ultimaFlotilla, ultimoCarro);

                break;

            case 2: //reservar agencias

                insertar_Nodo(true,5, ultimoHotel, ultimoPiso, ultimaHabitacion, ultimaAgencia, ultimaFlotilla, ultimoCarro);
                break;

            case 3: //todo incluido

                insertar_Nodo(true,6, ultimoHotel, ultimoPiso, ultimaHabitacion, ultimaAgencia, ultimaFlotilla, ultimoCarro);
                break;
