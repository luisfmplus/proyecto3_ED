...
LectorCola :: LectorCola(int numero){
  ...
  primero =  NULL;
  char textoPais[] = "proyecto3_ED-main\\Datos\\Paises.txt";
  char textoHoteles[] = "proyecto3_ED-main\\Datos\\Hoteles.txt";
  char textoPisos[] = "proyecto3_ED-main\\Datos\\PisosHotel.txt";
  char textoHabitas[] = "proyecto3_ED-main\\Datos\\Habitaciones.txt";
  char textoAgencias[] = "proyecto3_ED-main\\Datos\\Agencias.txt";
  char textoFlotillas[] = "proyecto3_ED-main\\Datos\\TipoFlotilla.txt";
  char textoCarros[] = "proyecto3_ED-main\\Datos\\Carros.txt";
  char textoUsuario[] = "proyecto3_ED-main\\Datos\\Usuarios.txt";
  char textoAdminH[] = "proyecto3_ED-main\\Datos\\AdministradorH.txt";
  char textoAdminA[] = "proyecto3_ED-main\\Datos\\AdministradorA.txt";
...
void LectorCola :: leerArchivo(char* v){ // contiene buffer de 100, requiere que lo que se leera termine en '\000'
  ...
  if (file.fail() || file.eof()){
    cout << "archivo no existe o esta vacio: " << v << endl;
    return;
  }
